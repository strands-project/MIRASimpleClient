# Install script for directory: /localhome/demo/MyFirstProject
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "external")
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/external/boost/boost" TYPE DIRECTORY FILES "/opt/MIRA/external/boost/boost/geometry" FILES_MATCHING REGEX "/[^/]*$" REGEX "/\\.svn$" EXCLUDE)
...
IF(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  INCLUDE("/localhome/demo/MyFirstProject/build/debug/toolboxes/cmake_install.cmake")
  INCLUDE("/localhome/demo/MyFirstProject/build/debug/domains/cmake_install.cmake")
...
FILE(WRITE "/localhome/demo/MyFirstProject/build/debug/${CMAKE_INSTALL_MANIFEST}" "")
FOREACH(file ${CMAKE_INSTALL_MANIFEST_FILES})
  FILE(APPEND "/localhome/demo/MyFirstProject/build/debug/${CMAKE_INSTALL_MANIFEST}" "${file}\n")
ENDFOREACH(file)
